...
book3 = Book("Taste", "Stanley Tucci", "Non-Fiction - Memoir")
book4 = Book("I'm a Fan", "Sheena Patel", "Fiction - Contemporary")
book5 = Book("The Dry", "Jane Harper", "Fiction - Thriller")
